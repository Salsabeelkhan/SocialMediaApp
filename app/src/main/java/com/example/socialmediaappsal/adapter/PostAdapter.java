package com.example.socialmediaappsal.adapter;
...
import com.example.socialmediaappsal.CommentActivity;
import com.example.socialmediaappsal.R;
import com.example.socialmediaappsal.User;
import com.example.socialmediaappsal.databinding.DashboardRvDesignBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.viewHolder>{
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        FirebaseDatabase.getInstance().getReference()
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    holder.binding.like.setCompoundDrawablesWithIntrinsicBounds(R.drawable.heart2, 0, 0, 0);
                }else{
